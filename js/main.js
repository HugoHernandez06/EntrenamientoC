...
function agregarEnventos() {
  ...
  btn_volver4.addEventListener("click", () => {
    irA(ajustes);
  });
  ...
  btn_entrenamiento.addEventListener("click", () => {
    irA(entrenamiento);
  });
  btn_cuidados.addEventListener("click", () => {
    irA(cuidados);
  });
  ...
  btn_ajustesCuenta.addEventListener("click", () => {
    irA(ajustesCuenta);
  });
  btn_cerrarSecion.addEventListener("click", () => {
    irA(menuLogin);
  });
  ...
  for (var i = 0; i <= 1; i++) {
    btn_volver[i].addEventListener("click", () => {
      irA(menuLogin);
    });
  ...
  for (var i = 0; i <= 1; i++) {
    btn_volver3[i].addEventListener("click", () => {
      irA(entrenamiento);
    });
